...
[macFadeOut]
[Talk name=ÐÄ¤ÎÉù]
²ËÄË»¨ÏòÎÒÐØ¿ÚÆËÀ´£¬ÕâÊÆÍ·ÈÃÎÒÃÇ¶¼µ¹ÔÚÁË
´²ÉÏ¡£
[Hitret]
[Talk name=ÐÄ¤ÎÉù]
¾ÍÔÝÇÒÕâÑù£¬ÒÔÈÔ¾ÉÏàÁ¬µÄ×´Ì¬£¬
ÈÃÆ£±¹µÄÉíÌåµÃÒÔÐÝÏ¢¡£
[Hitret]

[eval exp="s.dicReplayFlagA1 = 1"]
[macSystemSave]
...
; ------------------------------------------------------------------------------
[Change file=A0005A_A01.ks]/ï¼Šç¾åœ¨è¡¨ç¤ºã•ã‚Œã¦ã„ã‚‹ç”»é¢ã‚’ã‚­ãƒ£ãƒ—ãƒãƒ£ãƒ¼ã—ã¦æœ€å‰é¢ã«è¡¨ç¤º
[transSet]
...
[Voice file=A0004_A02216]
[Talk name=èœä¹ƒèŠ±]
ã€Œæ™´çœŸå›æœ€å–œæ¬¢äº†ã€
[Hitret]
; //ï¼Šãƒ•ã‚§ãƒ¼ãƒ‰ã‚¢ã‚¦ãƒˆï¼ˆé»’ã§1000msï¼‰
[macFadeOut]
[Talk name=å¿ƒã®å£°]
èœä¹ƒèŠ±å‘æˆ‘èƒ¸å£æ‰‘æ¥ï¼Œè¿™åŠ¿å¤´è®©æˆ‘ä»¬éƒ½å€’åœ¨äº†
åºŠä¸Šã€‚
[Hitret]
[Talk name=å¿ƒã®å£°]
å°±æš‚ä¸”è¿™æ ·ï¼Œä»¥ä»æ—§ç›¸è¿žçš„çŠ¶æ€ï¼Œ
è®©ç–²æƒ«çš„èº«ä½“å¾—ä»¥ä¼‘æ¯ã€‚
[Hitret]
